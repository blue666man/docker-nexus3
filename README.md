...
A Dockerfile for Sonatype Nexus Repository Manager 3, based on Alpine Linux.  Credits to (https://github.com/anapsix/docker-alpine-java "Anapsix Excellent alpine-java project").
